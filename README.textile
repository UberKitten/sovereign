*This is my (T3hUb3rK1tten's) fork of sovereign, modified for my own purposes. It has some unnecessary services disabled by default and tweaks added. Contact me on https://mwe.st if you have any questions.*
...
# A wildcard SSL certificate. You can either buy one or self-sign if you want to save money. *Or one certificate for each domain, available free from StartCom CA*.
